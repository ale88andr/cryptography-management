...
def upgrade() -> None:
    ...
    op.create_table('cryptography_key_carrier_type',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=50), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    op.create_table('cryptography_manufacturer',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=50), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    ...
    op.create_table('employee_location_building',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=50), nullable=False),
    ...
    op.create_table('employee_organisation',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('cryptography_key_carrier',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('serial', sa.String(length=50), nullable=False),
    sa.Column('carrier_type_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['carrier_type_id'], ['cryptography_key_carrier_type.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('serial')
    )
    op.create_table('cryptography_model',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=50), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('type', sa.Enum('PROGRAM', 'HARDWARE', 'HARDSOFT', name='modeltypes'), nullable=False),
    sa.Column('manufacturer_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['manufacturer_id'], ['cryptography_manufacturer.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    ...
    sa.ForeignKeyConstraint(['building_id'], ['employee_location_building.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    ...
    sa.ForeignKeyConstraint(['location_id'], ['employee_location.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['organisation_id'], ['employee_organisation.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['position_id'], ['employee_position.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('cryptography_act_record',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('action_type', sa.Enum('С_INSTALL', 'C_DESTRUCTION', 'I_INSTALL', 'I_REMOVE', 'KD_INSTALL', 'KD_REMOVE', name='actrecordtypes'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['commision_member_id'], ['employee.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['head_commision_member_id'], ['employee.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['performer_id'], ['employee.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('number')
    )
    op.create_table('cryptography_version',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('version', sa.String(length=50), nullable=False),
    sa.Column('grade', sa.Enum('KC1', 'KC2', 'KC3', 'KB1', 'KB2', 'KA1', name='cryptographygrade'), nullable=False),
    sa.Column('serial', sa.String(length=50), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', now())"), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', now())"), nullable=False),
    sa.ForeignKeyConstraint(['install_act_record_id'], ['cryptography_act_record.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['model_id'], ['cryptography_model.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['remove_act_record_id'], ['cryptography_act_record.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['responsible_user_id'], ['employee.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('cryptography_key_document',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('serial', sa.String(length=50), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', now())"), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', now())"), nullable=False),
    sa.ForeignKeyConstraint(['carrier_id'], ['cryptography_key_carrier.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['cryptography_version_id'], ['cryptography_version.id'], ondelete='CASCADE'),
    ...
    op.create_table('cryptography_hardware_logbook',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('equipment_id', sa.String(length=25), nullable=False),
    sa.Column('happened_at', sa.Date(), nullable=False),
    sa.Column('cryptography_version_id', sa.Integer(), nullable=False),
    sa.Column('record_type', sa.Enum('C_INSTALL', 'C_REMOVE', 'C_UPDATE', 'KD_INSTALL', 'KD_REMOVE', 'KD_DISCREDIT', 'C_MAINTANCE', 'C_FAILURE', name='hardwarelogbookrecordtype'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['cryptography_version_id'], ['cryptography_version.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['equipment_id'], ['equipment.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['key_document_id'], ['cryptography_key_document.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['remove_action_id'], ['cryptography_act_record.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('cryptography_personal_account',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['cryptography_version_id'], ['cryptography_version.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['equipment_id'], ['equipment.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['install_action_id'], ['cryptography_act_record.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['key_document_id'], ['cryptography_key_document.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['remove_action_id'], ['cryptography_act_record.id'], ondelete='CASCADE'),
